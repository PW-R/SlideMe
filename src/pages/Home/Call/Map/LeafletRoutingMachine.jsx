  ...
  useEffect(() => {
    if (origin && destination) {
      ...
      const carIcon = L.divIcon({
        ...
        html: `<div style="background-color: white; width: 20px; height: 20px; border-radius: 50%; border: 2px solid black;"></div>`,
        iconSize: [30, 30],
        iconAnchor: [10, 0],
        popupAnchor: [0, -50],
      });
      ...
      routingControl.on("routesfound", function (e) {
        ...
        const moveCar = () => {
          if (i < coordinates.length) {
            ...
            i++;
            setTimeout(moveCar, 300); // Adjust speed if necessary
          }
        };
        moveCar();
      });
      ...
      if (controlContainer) {
        controlContainer.remove(); // Hide default control container
      }
